...
from fastavro_jana.const import (
...
def writer(fo,
    ...
    validator: None, True or a function
        ...
        then fastavro_jana.writer.validate will be used. If it's a function, it
        should have the same signature as fastavro_jana.writer.validate and
        raise an exeption on error.
